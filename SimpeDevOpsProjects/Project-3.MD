...
Enable the password based authentication for Docker server -
# vi /etc/ss/ssh_config
give - "Password authentication yes" in file
...
C) send files or execute commands over SSH - POST BUILD STEPS 
 Name: docker_host  
